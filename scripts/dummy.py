"""
Dummy script for segfault debugging.
"""
...
if __name__ == "__main__":
    ...
    # Auxiliary mapping: agent id to agent position in env.all_agents (list[Agent]) 
    agent_mapping = {agent.id : i for i,agent in enumerate(env.all_agents)}
